...
function Langue() {
  ...
  useEffect(() => {
    const checkIfClickedOutside = (e) => {
      ...
      // then close the menu
      if (isLangOpen && ref.current && !ref.current.contains(e.target)) {
        setIsLangOpen(false);
      }
    };
  ...
  return (
    <>
      <button
        className={"lang-component " + (isLangOpen ? "active" : "")}
        onClick={() => setIsLangOpen((oldState) => !oldState)}
        ref={ref}
      >
        {earth}
        <span>{t("lang")}</span>
        <div className={"list-languages " + (isLangOpen ? "active" : "")}>
          <div className="to"></div>
          <div className="list">
            <div
              className={"lng " + (i18n.language === "en" ? "active" : "")}
            ...
            <div
              className={"lng " + (i18n.language === "ar" ? "active" : "")}
            ...
            >
              <img
                ...
                alt=""
              />
              <div className="name ar">العربية</div>
            </div>
            <div
              className={"lng " + (i18n.language === "fr" ? "active" : "")}
            ...
            >
              <img
                ...
                alt=""
              />
              <div className="name">Francais</div>
            </div>
          </div>
        </div>
      </button>
